...
def create_interface_in_netbox(interface):
    pass
...
def write_interface_in_file(interface, region, host, output_file_name, fieldnames, delimiter=","):
    """
    Write info in csv file
    :param interface: interfaces list
...
def main():
    ...
    for host in hosts.keys():
        ...
        for interface in interfaces:
            write_interface_in_file(interface, region, host, output_file_name, fieldnames)
            create_interface_in_netbox()
