...
def write_interface_file(interface, host, output_file_name, fieldnames, delimiter=","):
    """
    ...
    with open(f'files/{output_file_name}.csv', 'a') as csv_file:
        ...
        row = {"Region": host.get('region'), "Device": host.get('hostname'),
